...
/* package plutus-tx-template-0.5.0.0 */
#ifndef VERSION_plutus_tx_template
#define VERSION_plutus_tx_template "0.5.0.0"
#endif /* VERSION_plutus_tx_template */
#ifndef MIN_VERSION_plutus_tx_template
#define MIN_VERSION_plutus_tx_template(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  5 || \
  (major1) == 0 && (major2) == 5 && (minor) <= 0)
#endif /* MIN_VERSION_plutus_tx_template */
...
#define CURRENT_PACKAGE_KEY "plutus-tx-template-0.5.0.0-inplace-scripts"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "plutus-tx-template-0.5.0.0-inplace-scripts"
